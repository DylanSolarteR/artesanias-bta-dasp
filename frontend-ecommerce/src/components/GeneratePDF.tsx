    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.section}>
        <View style={styles.containerBetween}>
          ...
          <Text style={styles.encabezadoDatos}>
      ...
      <View style={styles.table}>
        <View style={styles.tableContainer}>
          <View style={styles.rowHeader}>
            ...
            <Text style={styles.cellHeader}>Tipo de venta</Text>
            <Text style={styles.cellHeader}>Punto Físico</Text>
            <Text style={styles.cellHeader}>Cantidad vendida</Text>
            <Text style={styles.cellHeader}>Ventas totales</Text>
          </View>
          {sales.map((sale, index) => (
            <View
              style={[
                styles.row,
                index % 2 ? { backgroundColor: "#f1f1f1" } : {},
              ]}
              key={index}
            >
              <Text style={styles.cell}>{sale.product}</Text>
              <Text style={styles.cell}>{sale.category}</Text>
              <Text style={styles.cell}>{sale.typeSale}</Text>
              <Text style={styles.cell}>{sale.physicalLocation}</Text>
              <Text style={styles.cell}>{sale.quantitySold}</Text>
              <Text style={styles.cell}>{sale.totalSales}</Text>
            </View>
          ))}
        </View>
      </View>
      ...
      <View style={styles.footer} fixed>
        <Text>
          Dirección: Cr 37 B 38 # 43 Sur | Correo: artesanias@gmail.com |
          Teléfono: 31064785746
        </Text>
        <Text
