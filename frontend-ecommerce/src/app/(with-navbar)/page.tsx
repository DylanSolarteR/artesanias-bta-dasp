        ...
        <div className="flex-column">
            ...
            <section className="section-presentation">
                <Image
                    ...
                    height={70}
                />
                <p className="mb-0">Empresa dedicada a la comercialización de productos artesanales colombianos, destacando la riqueza cultural y las tradiciones de las diferentes regiones del país.</p>
            </section>
            ...
            <section className="section-maps">
                <h1 className="section-title text-center">- Conoce nuestras tiendas -</h1>
                <p className="mb-0">Empresa dedicada a la comercialización de productos artesanales colombianos, destacando la riqueza cultural y las tradiciones de las diferentes regiones del país.</p>
                <Suspense fallback={<Loading />}>
                            ...
                            <form>
                                ...
                                <div className="form-row">
                                    <div className="form-group col-sm-4">
                                        <input type="text" className="form-control text-white rounded-0 bg-transparent" name="name" placeholder="Name"></input>
                                    </div>
                                    <div className="form-group col-sm-4">
                                        <input type="email" className="form-control text-white rounded-0 bg-transparent" name="Email" placeholder="Email"></input>
                                    </div>
                                    <div className="form-group col-sm-4">
                                        <input type="text" className="form-control text-white rounded-0 bg-transparent" name="subject" placeholder="Subject"></input>
                                    </div>
                                    <div className="form-group col-12 mb-0">
                                        <button type="submit" id="button-standard">Send</button>
                                    </div>
                                </div>
                            </form>
                        </div>
